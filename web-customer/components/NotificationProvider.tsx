...
const VARIANT_STYLES: Record<NotificationVariant, { container: string; badge: string }> = {
  success: {
    container: 'border-green-200 bg-white text-green-900 shadow-green-100/70',
    badge: 'bg-green-100 text-green-800 border-green-200',
  },
  error: {
    container: 'border-red-200 bg-white text-red-900 shadow-red-100/70',
    badge: 'bg-red-100 text-red-800 border-red-200',
  },
  info: {
    container: 'border-indigo-200 bg-white text-indigo-900 shadow-indigo-100/70',
