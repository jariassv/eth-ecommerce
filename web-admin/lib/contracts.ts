...
export const ECOMMERCE_ABI = [
  ...
  'function getCompanyInvoices(uint256 companyId) external view returns (tuple(uint256 invoiceId, uint256 companyId, address customerAddress, uint256 totalAmount, uint256 timestamp, bool isPaid, bytes32 paymentTxHash, uint256 itemCount, address paymentToken, uint256 expectedTotalUSDT)[])',
